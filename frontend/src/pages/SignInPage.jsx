      ...
      <section className="ui-container grid min-h-[calc(100vh-82px)] items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="max-w-2xl">
          <h1 className="mt-6 max-w-xl font-serif text-5xl leading-tight text-slate-950 sm:text-6xl">
            Sign in and keep every document conversation in one place.
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            Upload contracts, lecture notes, or research PDFs and return to the exact answers you need without digging through pages again.
          </p>

          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {[
              { label: "Upload", value: "PDF, DOCX, TXT" },
              { label: "Ask", value: "Grounded answers" },
              { label: "Trace", value: "See your sources" },
            ].map((item) => (
              <div
                key={item.label}
        ...
        <div className="relative">
          ...
          <div className="ui-card relative">
            <div className="mb-8">
              <h2 className="text-center font-serif text-3xl text-slate-950">Sign in</h2>
            </div>
